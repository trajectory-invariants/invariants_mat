function plot_ISA_frame_movie2(T_isa, pose, trial, viewpoint, referencepoint, datatype, parameterization, application, view_fig, axis_font_size, label_font_size, step_size, wrenchtype, index)
...
%     screw_end = p_isa(index,:) + x_isa(index,:)*length_screw*1;
...
%     mArrow3(p_isa(index,:),p_isa(index,:)+arrow_length_isa*x_isa(index,:)*1.2,'color',darkred,'stemWidth',arrow_width_isa*1.0);
%     material dull
%     hold on
%     mArrow3(p_isa(index,:),p_isa(index,:)+arrow_length_isa*y_isa(index,:)*0.7,'color',green,'stemWidth',arrow_width_isa*0.50);
%     material dull
%     hold on
%     mArrow3(p_isa(index,:),p_isa(index,:)+arrow_length_isa*z_isa(index,:)*0.7,'color',blue,'stemWidth',arrow_width_isa*0.50);
%     material dull
%     hold on
